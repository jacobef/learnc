    ...
    steps: [
      {
        ...
        editable: false,
        instructions:
          "The order of operations you know from math class (PEMDAS) applies, and isn't affected by spacing.",
      },
      {
        code: "a = 1-3 * 4;\n",
        editable: true,
      ...
      },
      {
        ...
        editable: false,
        instructions:
          "Rounding happens at the division, so both 1/2s round to 0, so this becomes $c{a = 0 + 0;}, which is 0.",
      },
      {
        code: "a = 8 / -(2 + 1);\n",
        editable: true,
