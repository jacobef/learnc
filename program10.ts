  ...
  createProgramTemplate({
    ...
    steps: [
      ...
      },
      {
        ...
        editable: false,
        instructions:
          "The decimal part is dropped by each division itself, not at the end. Both $c{1/2} (0.5) and $c{3/4} (0.75) immediately round to 0, so this becomes $c{a = 0 + 0;}, which is $v{0}.",
      },
      {
        code: "a = 8 / -(2 + 1);\n",
        editable: true,
      ...
      },
      {
        ...
        editable: false,
        instructions:
          '$c{x == y} evaluates to 1 if x and y have equal values, and 0 if they don\'t. $c{==} has lower precedence than addition and subtraction.\n\nThe name of this operation is "equality".',
      },
      {
        code: "int d = b == 58;\n",
        editable: false,
      ...
      },
      {
        ...
        editable: true,
        instructions:
          "Remember that spacing doesn't affect order of operations.",
        hints: (ctx) => {
