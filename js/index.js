...
/// <reference path="./shared-core.ts" />
{
    ...
    if (main) {
        ...
        mainCopy.appendChild(document.createTextNode("This is a work-in-progress tutorial that teaches the C programming language. I'll try to update it with a new program every other day or so."));
        ...
        mainCopy.appendChild(document.createElement("br"));
        mainCopy.appendChild(document.createTextNode("Remember to always read the instructions!"));
        mainCopy.appendChild(document.createElement("br"));
        mainCopy.appendChild(document.createTextNode("Email feedback, bugs, etc to jacobef2@gmail.com."));
        mainCopy.appendChild(document.createElement("br"));
