...
createProgramTemplate({
    initialInstructions: "Here's our first program that performs an actually meaningful computation. It calculates the absolute value of $n{x}. It works no matter what $n{x}'s value is.",
    steps: [
        {
            code: "int x = -91;\n",
            editable: false,
