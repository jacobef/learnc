    ...
    steps: [
        {
            code: "int tree = 5;\n",
            editable: false,
            instructions: "The block after $c{if (3-3)} will run if $c{3-3} is non-zero. Otherwise, it will be skipped.",
        },
        {
            code: "if (3-3) {\n",
            editable: false,
        ...
        },
        {
            code: "if (tree == 10) {\n",
            editable: true,
            instructions: "In the Code pane, select the line boundary where execution will resume. If the $c{if} block will be run, select the boundary between lines 10 and 11. If not, select the boundary between lines 12 and 13. Then press $checkButton.",
        },
        {
            code: "  olive = -olive;\n",
            editable: false,
