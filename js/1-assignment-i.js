...
createProgramTemplate({
    initialInstructions: "Use the $runLineButton button, or the right arrow key, to see how the code changes the program state.",
    steps: [
        {
            code: "int m;\n",
            editable: false,
        ...
        },
        {
            ...
            editable: false,
            scrollUp: false,
            instructions: "When you click $runLineButton, you will be prompted to edit the program state.",
        },
        {
            code: "m = 5;\n",
            editable: true,
