...
function syntaxDiagnostic(context) {
...
function declarationDiagnostic(context) {
...
function executionDiagnostic(context) {
    const { message, col, lines, safeLine, text } = context;
...
function fallbackDiagnostic(context) {
