...
if (n >= 0) {
  ...
  rounded = n - 0.5;
    ...
    textareaMinLines: 9,
    instructions: "Write code that creates an $t{int} variable named $n{rounded}, which is $n{n} rounded to the nearest integer. This level includes both positive and negative inputs.\n",
    hints: (ctx) => {
