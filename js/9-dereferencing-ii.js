...
createProgramTemplate({
    ...
    steps: [
        ...
        },
        {
            code: "wolf = &hare;\n",
            editable: false,
            instructions: "When $n{wolf} is assigned to $c{&hare}, the $n{*wolf} name moves from $n{deer} to $n{hare}.",
        },
        {
            code: "int** bear;\n",
            editable: false,
        },
        {
            code: "bear = &wolf;\n",
            editable: false,
            instructions: "$c{bear = &wolf;} adds names to $n{wolf} and $n{hare}. Use the $showAliasesButton buttons under those variables to reveal them.",
        },
        {
            code: "int* fox = wolf;\n",
            editable: true,
